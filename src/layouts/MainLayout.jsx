    ...
    return (
        <>
            ...
            <main className="flex-1 ml-64 overflow-x-hidden pt-20">
                {/* Scaled Wrapper: Includes origin-top and safety padding */}
                <div className="w-full mx-auto p-4 transition-transform duration-200 origin-top min-[2500px]:scale-[1.5] min-[2500px]:w-[66.666%] min-[3500px]:scale-[2.0] min-[3500px]:w-[50%]">
